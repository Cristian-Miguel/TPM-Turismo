...
CREATE TABLE IF NOT EXISTS `Turismo`.`Organizador` (
  ...
  INDEX `Foreign_idReserva_idx` (`idReserva` ASC) VISIBLE,
  INDEX `Foreign_idFavorito_idx` (`idFavoritos` ASC) VISIBLE,
  INDEX `Foreign_idPaquete_idx` (`idPaquete` ASC) VISIBLE,
  INDEX `Foreign_idHotel_idx` (`idHotel` ASC) VISIBLE,
  INDEX `Foreign_idViaje_idx` (`idViaje` ASC) VISIBLE,
