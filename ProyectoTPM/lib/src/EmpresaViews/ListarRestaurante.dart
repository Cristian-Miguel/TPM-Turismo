...
class ListarRestaurantes extends StatefulWidget{
  ...
  State<StatefulWidget> createState(){
    return _ListarRestaurantes();
  }
}

class _ListarRestaurantes extends State<ListarRestaurantes> {
    ...
    Navigator.of(context).push(
        MaterialPageRoute(
            builder:(context)
            {
              return Scaffold(
                appBar: AppBar(
                    title: const Text('Agregar Restaurantes', style: TextStyle(color: Colors.black),),
