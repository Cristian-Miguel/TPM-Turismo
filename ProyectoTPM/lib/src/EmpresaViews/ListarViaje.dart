...
class _ListarViajes extends State<ListarViajes> {
  ...
  getReservas() async {
    ...
    //para telefono
    // var url = Uri.parse('http://10.0.2.2:4000/empresa/Viajes');

    // para web
    var url = Uri.parse('http://localhost:4000/empresa/Viajes');
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        child: Container(
                          ...
                          child: Text(
                            ServiciosData[index]["idViaje"].toString(),
                      ...
                      SizedBox(
                        child:Container(
                          ...
                          alignment: Alignment.centerLeft,
                          child: Text(
                            ServiciosData[index]["Origen"].toString(),
                            style: const TextStyle(
                              fontWeight: FontWeight.normal,
                              fontSize: 18,
                            ),
                      ...
                      SizedBox(
                        child:Container(
                          ...
                          alignment: Alignment.centerLeft,
                          child: Text(
                            ServiciosData[index]["Destino"].toString(),
                            style: const TextStyle(
                              fontWeight: FontWeight.normal,
                              fontSize: 18,
                            ),
                      ...
                      SizedBox(
                        child:Container(
                          ...
                          alignment: Alignment.centerLeft,
                          child: Text(
                            ServiciosData[index]["NumPlazas"].toString(),
                            style: const TextStyle(
                              fontWeight: FontWeight.normal,
                              fontSize: 18,
                            ),
