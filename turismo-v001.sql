...
START TRANSACTION;
USE `Turismo`;
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (1, 'Buffet  regional', 'Disfrute de una buena variedad de comida tipicas de Mexico', "https://th.bing.com/th/id/R.1b70ecd382f9467d60dab7303d8794b5?rik=HqkO4AVAuwXz5g&riu=http%3a%2f%2flh5.ggpht.com%2f-ZPSfkbYWxSg%2fTxiWFjWWEtI%2fAAAAAAAAC4g%2fnQjCx_CP4V4%2fbuffet%25252520morelia%25252520%252525283%25252529_thumb%2525255B1%2525255D.jpg%3fimgmax%3d800&ehk=NbSB1hK9v7q9ij3r3L6Uo3q1lnv1oetP1CTH3ZpczB4%3d&risl=&pid=ImgRaw&r=0", 300.00, 'Buffet', 0.00, 4.1, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (2, 'La Conspiracion de 1809', 'Apto para vegetarianos, Opciones veganas, Opciones sin gluten', "https://media-cdn.tripadvisor.com/media/photo-s/12/42/aa/63/el-portal-allende.jpg", 80.00, 'Internacional', 10.00, 4.5, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (3, 'Mandala Pizzas', 'Apto para vegetarianos, Opciones veganas', "https://media-cdn.tripadvisor.com/media/photo-s/18/b3/00/56/una-de-nuestras-deliciosas.jpg", 50.00, 'Pizzeria', 5.00, 4.0, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (4, 'Jardin Steak House', 'Un restaurante de comida internacional encontrado en Uruapan.', "https://media-cdn.tripadvisor.com/media/photo-s/07/c9/71/ba/jardin-steak-house.jpg", 50.00, 'Internacional', 0.00, 4.3, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (5, 'La Cocina Michoacana', 'Un restaurante en Morelia con comida de tipo Mexicana, Latina, Contemporanea', "https://media-cdn.tripadvisor.com/media/photo-s/1b/8b/dd/17/restaurante-lu-cocina.jpg", 45.00, 'Michoacana', 5.00, 4.8, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (6, 'Casa Del Naranjo Restaurante', 'Apto para vegetarianos, Opciones veganas, Opciones sin gluten', "https://media-cdn.tripadvisor.com/media/photo-s/21/71/59/12/que-evento-te-imaginas.jpg", 42.00, 'Michoacana', 6.00, 4.2, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (7, 'el Patio restaurant', 'Apto para vegetarianos, Opciones veganas, Opciones sin gluten', "https://media-cdn.tripadvisor.com/media/photo-s/12/9d/d3/d0/restaurante-el-patio.jpg", 32.00, 'Michoacana', 4.00, 4.3, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (8, 'El Arriero Churrasqueria', 'La mejor churrasqueria de La piedad Michoacan', "https://media-cdn.tripadvisor.com/media/photo-s/0a/2e/eb/02/el-arriero-churrasqueria.jpg", 50.00, 'Churrasqueria', 0.00, 3.9, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (9, 'El Pulpo', 'Disfrute de nuestro riquisimos marisco en el pueto de Lazaro Cardenas', "https://media-cdn.tripadvisor.com/media/photo-s/08/1f/bb/81/enramada-el-pulpo.jpg", 34.00, 'Marisqueria', 3.00, 4.1, 2);
INSERT INTO `Turismo`.`Restaurantes` (`idRestaurante`, `Nombre`, `Descripcion`, `Imagen`, `Costo`, `Categoria`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (10, 'Los Balcones', 'Si deseas pasar un momento unico ven a nuestro restaurante de mariscos', "https://media-cdn.tripadvisor.com/media/photo-s/1d/ee/58/8b/balcones.jpg", 52.00, 'Marisqueria', 6.00, 4.5, 2);
...
START TRANSACTION;
USE `Turismo`;
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (1, 'Restaurante', '2022-05-05', '2022-05-15', 'Efectivo', 1, NULL);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (2, 'Hotel', '2022-05-05', '2022-05-15', 'Efectivo',NULL , 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (3, 'Tour', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (4, 'Restaurante', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (5, 'Hotel', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (6, 'Tour', '2022-05-05', '2022-05-15', 'Efectivo', 1,NULL);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (7, 'Restaurante', '2022-05-05', '2022-05-15', 'Efectivo', 1,NULL);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (8, 'Hotel', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (9, 'Tour', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
INSERT INTO `Turismo`.`Reserva_Servicio` (`idReserva`, `Tipo de servicio`, `FechaEntrada`, `FechaSalida`, `FormaPago`, `idTurista`, `idUsuario`) VALUES (10, 'Restaurante', '2022-05-05', '2022-05-15', 'Efectivo',NULL, 1);
...
INSERT INTO `Turismo`.`Tour` (`idTour`, `Nombre`, `Descripcion`, `Imagen`, `Cantidad`, `Costo`, `Ciudad`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (4, 'Caminos de Apatzingan', 'Re-contextualized hybrid complexity', "https://i.pinimg.com/originals/89/4e/2c/894e2cd4557100e402d0e08dae877620.jpg", 30, 127.00, 'Aparzingan', 40.00, 3.0, 2);
INSERT INTO `Turismo`.`Tour` (`idTour`, `Nombre`, `Descripcion`, `Imagen`, `Cantidad`, `Costo`, `Ciudad`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (5, 'Tour Charo', 'Optional ', "https://i.pinimg.com/originals/bb/0a/24/bb0a249626944e13b6a2f7a1f7f98d7b.jpg", '40', 134.00, 'Charo', 30.00, 4.0, 2);
INSERT INTO `Turismo`.`Tour` (`idTour`, `Nombre`, `Descripcion`, `Imagen`, `Cantidad`, `Costo`, `Ciudad`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (6, 'Tour Lazaro Cardenas', 'Universal maximized analyzer', "https://www.playasmexico.com.mx/wp-content/uploads/2008/09/lazaro-cardenas.jpg", 30, 300.00, 'Lazaro Cardenas', 30.00, 5.0, 2);
...
INSERT INTO `Turismo`.`Tour` (`idTour`, `Nombre`, `Descripcion`, `Imagen`, `Cantidad`, `Costo`, `Ciudad`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (9, 'Tour Mariposa Monarca', 'Seamless object-oriented synergy', "https://th.bing.com/th/id/OIP.F6B8MfcA1pdYd5HOTYpFGgHaEK?pid=ImgDet&rs=1", 50, 143.00, 'Tuzantia', 50.00, 3.0, 2);
INSERT INTO `Turismo`.`Tour` (`idTour`, `Nombre`, `Descripcion`, `Imagen`, `Cantidad`, `Costo`, `Ciudad`, `Descuento`, `Calificacion`, `idUsuario`) VALUES (10, 'Recorrido por Paracho', 'Upgradable composite support', "https://tolucalabellacd.com/wp-content/uploads/2020/07/arton23614.jpg", 20, 100.00, 'Kvartsitnyy', 10.00, 2.0, 2);
...
START TRANSACTION;
USE `Turismo`;
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (1, 'Favorito', NULL,    1, NULL,    1, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (2, 'Reserva',     1, NULL, NULL, NULL, NULL,    1, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (3, 'Favorito', NULL,    2, NULL, NULL, NULL, NULL,    1);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (4, 'Reserva',     2, NULL, NULL,    2, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (5, 'Favorito', NULL,    3, NULL, NULL, NULL,    2, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (6, 'Reserva',     3, NULL, NULL, NULL, NULL, NULL,    2);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (7, 'Favorito', NULL,    4, NULL,    3, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (8, 'Reserva',     4, NULL, NULL, NULL, NULL,    3, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (9, 'Favorito', NULL,    5, NULL, NULL, NULL, NULL,    3);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (10, 'Reserva',    5, NULL, NULL,    4, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (11, 'Favorito',NULL,    6, NULL, NULL, NULL,    4, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (12, 'Reserva',    6, NULL, NULL, NULL, NULL, NULL,    4);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (13, 'Favorito',NULL,    7, NULL,    5, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (14, 'Reserva',    7, NULL, NULL, NULL, NULL,    5, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (15, 'Favorito',NULL,    8, NULL, NULL, NULL, NULL,    5);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (16, 'Reserva',    8, NULL, NULL,    6, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (17, 'Favorito',NULL,    9, NULL, NULL, NULL,    6, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (18, 'Reserva',    9, NULL, NULL, NULL, NULL, NULL,    6);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (19, 'Favorito',NULL,   10, NULL,    7, NULL, NULL, NULL);
INSERT INTO `Turismo`.`Organizador` (`idOrganizador`, `TipoGuardado`, `idReserva`, `idFavoritos`, `idPaquete`, `idHotel`, `idViaje`, `idRestaurante`, `idTour`) VALUES (20, 'Reserva',   10, NULL, NULL, NULL, NULL,    7, NULL);
